...
-- ----------------------------
-- Table structure for `pri_jnlno`
-- ----------------------------
DROP TABLE IF EXISTS `pri_jnlno`;
CREATE TABLE `pri_jnlno` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `order_id` bigint(20) NOT NULL COMMENT '订单id',
  `jnlno` bigint(20) NOT NULL COMMENT '订单编号',
  `prd_id` bigint(20) NOT NULL COMMENT '商品id',
  ...
  KEY `pri_jnlno` (`jnlno`),
  KEY `pri_prdid` (`prd_id`),
  CONSTRAINT `pri_jnlno` FOREIGN KEY (`jnlno`) REFERENCES `order` (`jnlno`),
  CONSTRAINT `pri_orderid` FOREIGN KEY (`order_id`) REFERENCES `order` (`id`),
  CONSTRAINT `pri_prdid` FOREIGN KEY (`prd_id`) REFERENCES `product` (`prd_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=COMPACT;

-- ----------------------------
-- Records of pri_jnlno
-- ----------------------------
